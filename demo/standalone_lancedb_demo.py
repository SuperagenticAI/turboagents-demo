...
def main() -> None:
    ...
    print(style("TurboAgents standalone LanceDB demo", BOLD, CYAN))
    print(style("TurboQuant-style path: 3.5-bit compressed index with reranked LanceDB candidates", YELLOW))
